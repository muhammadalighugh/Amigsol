...
export default function PartnerSignUpFlow() {
  ...
  const [formData, setFormData] = useState({
    ...
    // Step 5 - Program Specific Details
    hearAboutUs: '',
    targetAudience: [],
    marketingChannels: [],
    payoutMethod: '',
  ...
  const hearAboutUsOptions = [
    'Social Media', 'Friend/Referral', 'Event/Conference', 'Search Engine',
    'Blog/Article', 'YouTube', 'LinkedIn', 'Other'
  ];

  const targetAudienceOptions = ['Small Business', 'Medium Enterprise', 'Large Corporation', 'Startups'];
  
  const marketingChannelsOptions = [
    'Social Media', 'Blog Writing', 'YouTube Channel', 'Events/Conferences',
    'Email Marketing', 'Personal Network', 'Cold Outreach', 'Content Creation'
  ];

  const payoutMethods = ['Bank Transfer', 'PayPal', 'Wise', 'Cryptocurrency', 'Stripe', 'Other'];

  const skillsOptions = [
    'React', 'Next.js', 'Node.js', 'Python', 'AI/ML', 'WordPress', 'Shopify',
    'Mobile Development', 'UI/UX Design', 'DevOps', 'Blockchain', 'Data Science'
  ];
    ...
    switch (step) {
      ...
      case 4:
        if (formData.partnershipType === 'developer') {
          if (!formData.education[0].degreeName.trim()) newErrors.education = 'At least one education entry is required for developers';
        }
        break;
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-black dark:text-white mb-4">Create Your Account</h2>
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                {formData.partnershipType === 'developer' ? 'Required for developer partners' : 'Optional for referral partners'}
              </p>
            </div>

            <div className="space-y-6">
              {formData.education.map((edu, index) => (
                <div key={index} className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg bg-white/50 dark:bg-gray-800/50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                        Degree/Certification Name {formData.partnershipType === 'developer' && index === 0 ? '*' : ''}
                      </label>
                      <input
                        type="text"
      ...
      case 5:
        if (formData.partnershipType === 'referral') {
          return (
            <div className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-black dark:text-white mb-4">Referral Partner Details</h2>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {targetAudienceOptions.map(option => (
                      <label key={option} className="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:border-[#8BE31F]/50 transition-colors">
                        <input
                          type="checkbox"
          ...
          return (
            <div className="space-y-6">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-black dark:text-white mb-4">Developer Partner Details</h2>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {skillsOptions.map(skill => (
                      <label key={skill} className="flex items-center p-3 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:border-[#8BE31F]/50 transition-colors">
                        <input
                          type="checkbox"
            ...
            <div className="space-y-6">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-white/50 dark:bg-gray-800/50">
                ...
                <div className="space-y-4 text-sm text-gray-600 dark:text-gray-400">
                  <div className="flex items-start space-x-3">
                    ...
                    <span>Commission rates as specified: {formData.partnershipType === 'referral' ? '15-25%' : '30-40%'} based on performance tiers</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-4 h-4 text-[#8BE31F] flex-shrink-0 mt-0.5" />
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <label className="flex items-start">
                    ...
                    />
                    <span className="ml-3 text-sm text-gray-700 dark:text-gray-300">
                      I agree to the <button className="text-[#8BE31F] hover:underline font-medium">Partner Program Terms & Conditions</button> *
                    </span>
                  </label>
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                  <label className="flex items-start">
                    ...
                    />
                    <span className="ml-3 text-sm text-gray-700 dark:text-gray-300">
                      I agree to the <button className="text-[#8BE31F] hover:underline font-medium">Privacy Policy</button> *
                    </span>
                  </label>
              ...
              <div className="bg-[#8BE31F]/10 border border-[#8BE31F]/20 rounded-lg p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Once you submit this application, our team will review it within 24-48 hours. You'll receive an email with your partner dashboard access and next steps.
                </p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Form Card */}
        <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 px-8 lg:px-12 py-6 flex justify-between items-center border-t border-gray-200 dark:border-gray-700">
            ...
            {currentStep === totalSteps ? (
              <button
                ...
                className="group relative px-8 py-3 bg-[#8BE31F] text-black font-semibold rounded-lg transition-all duration-300 shadow-lg shadow-[#8BE31F]/25 hover:shadow-[#8BE31F]/40 overflow-hidden"
              >
